...
/** Gibbs sampler for a model with independent normal-gamma prior.
 */
class GibbsNG : public PosteriorSimulator {
    public:
        /** Constructs a new Gibbs sampler.
         *
         * \param k the number of coefficients in the model, not including the \f$s^2\f$ term.
         * \param X the X data
         * \param y the y data
